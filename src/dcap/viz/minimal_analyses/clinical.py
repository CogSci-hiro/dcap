# =============================================================================
#                               Clinical QC Placeholder
# =============================================================================
"""Clinical QC Placeholder (skeleton).
...
Usage example
    from dcap.viz.overview import clinical as mod
...
def make_figures(*, extra_title: str | None = None) -> dict[str, Any]:
    figs: dict[str, Any] = {}
    fig = plt.figure()
    label = "Clinical QC Placeholder".strip()
    if extra_title:
        label = f"{label} | {extra_title}"
    fig.suptitle(label)
    figs["clinical_placeholder"] = fig
    return figs
